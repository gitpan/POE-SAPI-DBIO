# This Makefile is for the POE::SAPI::DBIO extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI/DBIO.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI::DBIO]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI/DBIO.pm]
...
MAKE = make
FULLEXT = POE/SAPI/DBIO
BASEEXT = DBIO
PARENT_NAME = POE::SAPI
DLBASE = $(BASEEXT)
VERSION_FROM = lib/POE/SAPI/DBIO.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/POE/SAPI/DBIO.pm

PM_TO_BLIB = lib/POE/SAPI/DBIO.pm \
	blib/lib/POE/SAPI/DBIO.pm
...
DISTNAME = POE-SAPI-DBIO
DISTVNAME = POE-SAPI-DBIO-0.03
...
manifypods : pure_all  \
	lib/POE/SAPI/DBIO.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI/DBIO.pm $(INST_MAN3DIR)/POE::SAPI::DBIO.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               POE-SAPI-DBIO' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI/DBIO.pm blib/lib/POE/SAPI/DBIO.pm 
